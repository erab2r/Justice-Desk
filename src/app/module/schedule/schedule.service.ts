...
//   if (durationInMinutes % SLOT_DURATION_MINUTES !== 0) {
//     throw new AppError(
//       httpStatus.BAD_REQUEST,
//       `Schedule Duration Must Be Divisible By ${SLOT_DURATION_MINUTES} Minutes`,
//     );
//   }

//   return durationInMinutes / SLOT_DURATION_MINUTES;
// };
...
//       "Only Lawyer Can Create Schedule",
//     );
//   }
...
//     throw new AppError(
//       httpStatus.FORBIDDEN,
//       "Deleted Lawyer Cannot Create Schedule",
//     );
//   }
...
//     throw new AppError(
//       httpStatus.FORBIDDEN,
//       "Only Lawyer Can Update Schedule",
//     );
//   }
...
//     throw new AppError(
//       httpStatus.FORBIDDEN,
//       "Only Lawyer Can Update Schedule Status",
//     );
//   }
...
//     throw new AppError(
//       httpStatus.FORBIDDEN,
//       "Only Lawyer Can Delete Schedule",
//     );
//   }
...
//     throw new AppError(
//       httpStatus.FORBIDDEN,
//       "Only Lawyer Can View Own Schedules",
//     );
//   }
...
//     throw new AppError(
//       httpStatus.FORBIDDEN,
//       "Only Lawyer Can View Today's Schedules",
//     );
//   }
